        ...
        <div className="min-h-screen bg-sky-100 font-sans text-gray-800">
            ...
            <header className="bg-white shadow-sm">
                <div className="container mx-auto px-6 py-4 flex justify-between items-center">
                    ...
                    <nav>
                        ...
                        <Link href="/auth/login" className="px-4 py-2 font-semibold text-white bg-indigo-600 rounded-lg hover:bg-indigo-700 transition mr-2">
                            Login
                        </Link>
                        <Link href="/auth/signup" className="px-4 py-2 font-semibold text-white bg-indigo-600 rounded-lg hover:bg-indigo-700 transition ml-2">
                            Sign Up
                        </Link>
                    </nav>
                </div>
            ...
            <main className="container mx-auto px-6 py-20 text-center">
                <div className="w-full max-w-3xl mx-auto">
                    ...
                    {/* In a real Next.js app, you would use <Link href="/login"> */}
                    <Link href="#" className="inline-block px-8 py-4 font-bold text-white bg-indigo-600 rounded-full hover:bg-indigo-700 transition-transform transform hover:scale-105">
                        Get Started
                    </Link>
                </div>
            </main>
